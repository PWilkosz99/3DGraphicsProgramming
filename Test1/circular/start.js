...
let urls = [
	...
	"https://cdn.pixabay.com/photo/2016/11/23/15/06/wooden-floor-1853409_960_720.jpg",
	"https://cdn.pixabay.com/photo/2016/11/21/13/29/yellow-1845394_960_720.jpg",
	"https://cdn.pixabay.com/photo/2016/06/27/17/54/leaf-1482948_960_720.jpg",
	"https://i.imgur.com/vIkFoMu.png"
];
...
async function loadFile(file) {
	...
	points[selectedBuffer] = triangles.length * 3;
	verticles[selectedBuffer] = vert_array
...
function start() {
	...
	window.addEventListener('keydown', function (event) {
		switch (event.key) {
			...
			case '1':
				selectedBuffer = 0;
				console.log("Selected buffer 1");
				break;
			case '2':
				selectedBuffer = 1;
				console.log("Selected buffer 2");
				break;
			case '3':
				selectedBuffer = 2;
				console.log("Selected buffer 3");
				break;
			case '4':
				selectedBuffer = 3;
				console.log("Selected buffer 4");
				break;
			case '5':
				selectedBuffer = 4;
				console.log("Selected buffer 5");
				break;
		}
	}, false);
}